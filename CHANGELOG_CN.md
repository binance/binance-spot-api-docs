...
* **SBE: 模式 3:1 ([spot_3_1.xml](https://github.com/binance/binance-spot-api-docs/blob/master/sbe/schemas/spot_3_1.xml))**将于**2025-08-25 05:00 UTC** 进行更新。
  * 以下字段已被重命名，用于解决通过 [SbeTool](https://github.com/binance/binance-spot-api-docs/blob/master/faqs/sbe_faq.md#generate-sbe-decoders) 代码生成器所生成的 Java 代码被发现无法进行编译的问题。
