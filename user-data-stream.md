...
# User Data Streams for Binance (2022-08-08)
...
* REJECTED - The order has been rejected and was not processed. (This only occurs with Cancel Replace Orders wherein the new order placement is rejected but the request to cancel request succeeds.)
