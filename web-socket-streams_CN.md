...
{
  "e": "blockTrade",  // 事件类型
  "E": 1772506983582, // 事件时间
  "s": "BNBBTC",      // 交易对
  "t": 582,           // 大宗交易ID
  "p": "0.052",       // 成交价格
  "q": "5838",        // 成交数量
  "T": 1772506983321, // 成交时间
  "m": true           // 买方是否是做市方。
}
```
...
```javascript
{
    ...
    "s": "BNBBTC",              // 交易对
    "k": {
        "t": 1672515780000,     // 该K线的起始时间
        "T": 1672515839999,     // 该K线的结束时间
        "s": "BNBBTC",          // 交易对
        "i": "1m",              // K线间隔
        "f": 100,               // 该K线期间第一笔成交ID
        "L": 200,               // 该K线期间末一笔成交ID
        "o": "0.0010",          // 该K线期间第一笔成交价
        "c": "0.0020",          // 该K线期间末一笔成交价
        "h": "0.0025",          // 该K线期间最高成交价
        "l": "0.0015",          // 该K线期间最低成交价
        "v": "1000",            // 该K线期间成交量
        "n": 100,               // 该K线期间成交数量
        "x": false,             // 该K线是否完结（是否已经开始下一根K线）
        "q": "1.0000",          // 该K线期间成交额
        "V": "500",             // 主动买入的成交量
        "Q": "0.500",           // 主动买入的成交额
        "B": "123456"           // 忽略此参数
...
{
    "e": "avgPrice",           // 事件类型
    "E": 1693907033000,        // 事件时间
    "s": "BTCUSDT",            // 交易对
    "i": "5m",                 // 平均价格间隔
    "w": "25776.86000000",     // 平均价格
    "T": 1693907032213         // 结束时间
}
```
